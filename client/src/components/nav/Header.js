...
import {
    AppstoreOutlined, SettingOutlined, UserOutlined, UserAddOutlined,
...
const Header = () => {
    ...
    return (
        <Menu onClick={handleClick} selectedKeys={[current]} mode="horizontal">
            ...
            {user && <SubMenu key="SubMenu" className="float-right"
                icon={<SettingOutlined />} title={user.email && user.email.split("@")[0]}>
